...
{ "runtimeLedgers":       { "rocm-gfx1151": "<ledger/runtime-rocm-gfx1151.json の sha256（小文字 hex 64 字）>",
  ...
  "installedAppVersions": { "rocm-gfx1151": "v2.0.2", "cu126": "v2.0.2" } }
```
...
`AboutViewModel.VersionText(flavor)`（**`v2.0.2 － RTX（CUDA）`**）はここを読むので自動で揃う。
